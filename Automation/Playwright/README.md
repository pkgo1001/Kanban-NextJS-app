...
Opens: `Automation/Playwright/reports/html-report/index.html`

### Test Artifacts

- **Screenshots:** `Automation/Playwright/screenshots/` (on failure)
- **Videos:** `Automation/Playwright/videos/` (on failure)
- **Traces:** `Automation/Playwright/test-results/` (on retry)
